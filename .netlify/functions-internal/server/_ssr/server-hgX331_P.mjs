...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DZS-ZezQ.mjs");
...
const manifest = {
  "7bc9a4ed6bab3f9b0d836fe99edef5a4b37e9a06d0959846e75193f1e4c8e00e": {
    functionName: "submitTimeline_createServerFn_handler",
    importer: () => import("./contributor.functions-yTVXOXvq.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-UcaPU2uq.mjs").then((n) => n.r),
    import("./start-CpbFDgzq.mjs"),
