...
const Bold = createLucideIcon("bold", __iconNode$H);
const __iconNode$G = [
...
const FilePlusCorner = createLucideIcon("file-plus-corner", __iconNode$u);
const __iconNode$t = [
  [
    "path",
    {
...
const Group = createLucideIcon("group", __iconNode$p);
const __iconNode$o = [
...
const MailCheck = createLucideIcon("mail-check", __iconNode$d);
const __iconNode$c = [
...
const Ungroup = createLucideIcon("ungroup", __iconNode$3);
const __iconNode$2 = [
